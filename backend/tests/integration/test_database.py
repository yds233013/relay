...
def test_migrations_upgrade_downgrade_upgrade(
    ...
    head = head_revision()
    assert head == "0009_demo_visitor_role"
...
def test_ready_endpoint_against_real_database(
    ...
    with TestClient(create_app(settings)) as client:
        ...
        assert behind.json()["database"] == {
            ...
            "head_revision": "0009_demo_visitor_role",
        }
        ...
        assert ready.json() == {
            ...
            "database": {
                "reachable": True,
                "migrations": "at_head",
                "current_revision": "0009_demo_visitor_role",
                "head_revision": "0009_demo_visitor_role",
            },
        }
    assert current_revision(engine) == "0009_demo_visitor_role"
